        ...
        <form method="POST" action="{{ route("admin.events.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('location_name') ? 'is-invalid' : '' }}" type="text"
                    name="location_name" id="location_name" value="{{ old('location_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('slug') ? 'is-invalid' : '' }}" type="text" name="slug"
                    id="slug" value="{{ old('slug', '') }}" onkeyup="ChangeToSlug();" onclick="ChangeToSlug();"
                    required>
                @if($errors->has('slug'))
                <div class="invalid-feedback">
                    {{ $errors->first('slug') }}
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_video') ? 'is-invalid' : '' }}" type="text"
                    name="link_video" id="link_video" value="{{ old('link_video', '') }}">
